...
# Local imports
from spacy_utils import  get_morph, get_people_source, get_pronoun_on_sentence, get_pronoun_on_sentence_with_it, get_translation_with_punctuation, is_plural, get_only_subject_sentence, get_people, get_nlp_en, get_sentence_gender, get_nsubj_sentence, get_nlp_pt, get_noun_chunks
...
from constrained_beam_search import  get_constrained_subject_and_neutral, get_constraints_one_subj, get_constrained_translation, get_constraints_without_people, get_translation_constrained_and_aligned_different_gender, get_translation_constrained_and_aligned_same_gender,  get_translations_aligned, get_word_to_add
...
def generate_translation_for_nsubj_and_pobj_with_pronoun(source_sentence, google_translation):
    ...
    sub_split = get_roberta_subject(source_sentence)
    ...
    if (people_google == None or len(people_google) == 0) and len(people_model_nlp) > 0:
        ...
        translation_nlp = get_translation_constrained_and_aligned_different_gender(translation_nlp, people, source_sentence, sub_split)
